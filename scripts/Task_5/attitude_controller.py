...
class Edrone():
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/edrone/loop_break", String, self.loop)
    ...
    def pid(self):
        ...
        self.setpoint_euler[0] = (self.setpoint_cmd[0] * 0.02 - 30)*(3.14159/180)
        self.setpoint_euler[1] = (self.setpoint_cmd[1] * 0.02 - 30)*(3.14159/180)
        self.setpoint_euler[2] = (self.setpoint_cmd[2] * 0.02 - 30)*(3.14159/180)
        ...
        self.throtle_pwm = self.throttle*1.023 - 1023
        self.error = [0,0,0]
        ...
        self.error[2] = (self.setpoint_euler[2] - self.drone_orientation_euler[2])*10
        ...
        self.pwm_cmd.prop3 =  self.throtle_pwm - self.out_roll  - self.out_yaw 
        self.pwm_cmd.prop1 =  self.throtle_pwm - self.out_pitch - self.out_yaw 
        self.pwm_cmd.prop2 =  self.throtle_pwm - self.out_roll - self.out_pitch 
        self.pwm_cmd.prop4 =  self.throtle_pwm  


        if self.loop_check == "stop" and self.throttle == 1000:
            self.check = 1
        ...
        self.pitch_pub.publish(self.error[1]*10)
        self.yaw_pub.publish(self.error[2]*10)
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        e_drone.pid()
        r.sleep()
        if (e_drone.check ==1): #useing the last last publishded value to break the loop
            break
